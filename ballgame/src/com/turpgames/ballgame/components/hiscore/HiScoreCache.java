...
public final class HiScoreCache {
	...
	public static GetHiScoresResponse getHiScores(int days, boolean ignoreTimeout) {
		return getHiScores(days, BallGameMode.defaultMode, GetHiScoresRequest.General, ignoreTimeout);
	}
	...
	public static void putHiScores(int days, GetHiScoresResponse hiScores) {
		putHiScores(days, BallGameMode.defaultMode, GetHiScoresRequest.General, hiScores);
	}
